<? include ("header.html"); ?>
    ...
    <form method="post" id="formInsertarPost" action="insertarPost.php" class="mdl-cell--6-col">
        <div style="width:1450px" class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
...
<!--        <br>-->
<!--        Texto:<br>-->
        <div style="width:1450px; padding-top:51px" class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
